...
const Header = () => {
    ...
    const navbar = <>
      ...
      <p className='text-white uppercase   lg:py-0 p-1'><Link to='/about'>About us</Link></p>
        <p className='text-white uppercase lg:py-0 p-1'><Link to='/dashboard'>Dashboard</Link></p>
        <p className='text-white uppercase lg:py-0 p-1'><Link to='/dashboard/myorder'><div className=" rounded-lg flex items-center gap-1">
  ...
  <div className="badge badge-secondary">{cart.length}</div>
    ...
    return (
        <div className='mt-0'>
            ...
            <div>
                <nav className="fixed w-11/12 z-10 px-4 py-3 bg-black">
